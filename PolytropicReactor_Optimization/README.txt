This code bundle optimizes a pseudohomogeneous 2D steady state tubular reactor model in polytropic operation.Output data consists of optimized operating conditions and reactor geometry.
