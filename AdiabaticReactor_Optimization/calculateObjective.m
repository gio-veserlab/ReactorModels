function [output, conversion, selectivity, delta_P, final_T] = ...
    ...
    limiting_ratio, T0, P0, tube_count, Lr, whsv)

%% This function specifies the objective function to be minimized during 
% the optimization. Change objective fnc part in this script based on your system
% (last part)
...
%% Simulation of the steady-state reactor model to obtain conversion & selectivity
...
% the whsv !! CHANGE THE OBJECTIVE FNC BASED ON YOUR REACTION SYSTEM !!

output = -conversion*selectivity*whsv; % typically yield or productivity is optimized
end
